...
public class Navigation extends LinearLayout {
    ...
    private void setWeight(View view, int weight) {
        LayoutParams pr = (LayoutParams) view.getLayoutParams();
        pr.weight = weight;
    ...
    public Navigation addTab(String text, @LayoutRes int resId) {
        ...
        View.OnClickListener listener = v -> {
            if (selectedIndex != -1) {
                ...
                View contentView = current.getContentView();
                TextView navigationTextView = current.getNavigationTextView();
                setWeight(contentView, 2);
