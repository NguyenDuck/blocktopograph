...
public enum Entity implements NamedBitmapProviderHandle, NamedBitmapProvider {
    ...
    FALLING_SAND(66, "Falling Block", new String[]{"FallingBlock"}, "falling_sand", 50),
    ...
    MINECART_COMMAND_BLOCK(901, "Minecart with Command Block", new String[]{"MinecartCommandBlock"}, "minecart_with_command_block", 78),//100 ; MinecartCommandBlock is not yet in the game
